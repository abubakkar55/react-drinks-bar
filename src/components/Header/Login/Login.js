...
const Login = () => {
    const { allContext:
        { user, user: { displayName }, signInGoogle, SignInGithub, logOut, userSignIn, setEmail, setPassword, error, setUser, setError } }
        = useAuth();
                        ...
                        <div className="">
                            ...
                            <div className="p-3">
                                ...
                                <ul className="flex items-center justify-center py-3 gap-5 text-blue-500 text-lg">
                                    <li><a onClick={googleSignIn} href=""> <FaGoogle /> </a></li>
                                    <li><a onClick={githubSignIn} href=""> <FaGithub /> </a></li>
                                </ul>
                            </div>
                        </div>
                    </div> :
